...
public class WeaponController : MonoBehaviour
{
    ...
    public void Shoot()
    {
        //GameObject InstantiatedFakeBullet = Instantiate(FakeBullet);
        //Transform InstantiatedFakeBulletTransform = InstantiatedFakeBullet.transform;
        //InstantiatedFakeBulletTransform.position = new Vector3(-2f, 0f, 0f) * Time.deltaTime;
